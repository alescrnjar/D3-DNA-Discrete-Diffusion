...
def _run(rank, world_size, cfg):
    ...
    while state['step'] < num_train_steps + 1:
        ...
        #loss = train_step_fn(state, inputs) #VANILLA/C
        loss = train_step_fn(state, inputs, target) #V/CONDITIONING
        ...
        if step != state['step']:
            ...
            if step % cfg.training.eval_freq == 0:
                ...
                #eval_loss = eval_step_fn(state, eval_inputs) #VANILLA/C
                eval_loss = eval_step_fn(state, eval_inputs, eval_target) #V/CONDITIONING
